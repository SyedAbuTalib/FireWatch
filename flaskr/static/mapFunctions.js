...
function codeAddress() {
    ...
    markerArray = [];
    var loc = [];
    geocoder.geocode({ 'address': document.getElementById("ZipCode").value }, function(results, status) {
        if (status == google.maps.GeocoderStatus.OK) {
            ...
            $.get("/analysis/" + loc[0] + "/" + loc[1], function(data) {
                ...
                var lngs = linksAndGeoAndHeatMap[2].split("|||")
                var latsHeatMap = linksAndGeoAndHeatMap[3].split("|||")
                var lngsHeatMap = linksAndGeoAndHeatMap[4].split("|||")
